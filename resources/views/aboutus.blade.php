...
@section('content')
	...
	<section class="bg-ateam-div mt-5 pt-5 pb-5">
		<div class="container">
			<div class="row">
				<div class="col-md-4 px-0 bg-ateam bg-ateam1" data-aos="fade-right" data-aos-duration="1000"></div>
				<div class="col-md-4 px-0 bg-ateam bg-ateam2" data-aos="fade-down" data-aos-duration="1000"></div>
				<div class="col-md-4 px-0 bg-ateam bg-ateam3" data-aos="fade-left" data-aos-duration="1000"></div>
